...
- Peters Morgan, *Data Analysis from Scratch with Python*, AI Sciences.  
- Wes McKinny, *Python for Data Analysis*, O’Reilly.  
- Cyrille Rossant, *IPython Interactive Computing and Visualization Cookbook*, PACKT.  
